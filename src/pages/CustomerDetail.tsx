  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-blue-800 p-6 rounded-xl shadow-sm text-white">
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-end gap-3">
            ...
            <button onClick={() => {
              ...
              className="px-5 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-semibold shadow-sm transition-colors flex items-center"
            >
