...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .company  { font-size: 22px; font-weight: 900; color: #0078d4; letter-spacing: -0.5px; }
  ...
  .divider { border: none; border-top: 3px solid #0078d4; margin: 8px 0; }
  ...
  thead tr { background-color: #0078d4 !important; }
  th {
    padding: 5px 4px; font-weight: 700; text-align: center;
    border: 1px solid #0078d4; color: #fff;
    background-color: #0078d4 !important; font-size: 9.5px;
  }
  ...
  td.in     { color: #059669; }
  td.out    { color: #dc2626; }
  td.bal    { color: #0078d4; font-weight: 700; }
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 text-sm font-semibold bg-blue-800 text-white rounded-lg hover:bg-blue-900 transition-colors shadow-sm"
          >
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md">
            ...
            <div className="flex justify-end gap-3 px-6 py-4 border-t border-slate-100">
              ...
              <button
                ...
                className="flex items-center gap-2 px-5 py-2.5 bg-blue-800 text-white rounded-lg hover:bg-blue-900 font-semibold text-sm transition-colors disabled:opacity-40 disabled:cursor-not-allowed shadow-sm"
              >
