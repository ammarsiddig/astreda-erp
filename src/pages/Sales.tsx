...
<html><head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .company-name { font-size: 24px; font-weight: 800; color: #0078d4; }
    .company-sub { font-size: 10px; color: #64748b; margin-top: 3px; }
    .inv-meta { text-align: left; }
    .inv-num { font-size: 15px; font-weight: 700; color: #0078d4; }
    ...
    .total-label { font-size: 13px; font-weight: 700; color: #0078d4; }
    .total-value { font-size: 16px; font-weight: 800; color: #0078d4; }
        ...
        {viewInvoice && (
          <div className="space-y-4" dir="rtl">
            ...
            <div className="border border-slate-200 rounded-xl overflow-hidden">
              {/* Header */}
              <div className="flex justify-between items-start bg-blue-800 text-white px-6 py-4">
                <div>
              ...
              <div className="flex justify-between items-center px-6 py-4 bg-slate-50 border-t-2 border-slate-200">
                ...
                <span className="text-lg font-extrabold text-blue-900">{formatCurrency(viewInvoice.total)} SDG</span>
              </div>
            </div>
