...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .title { font-size: 16px; font-weight: 900; color: #003D6B; text-align: center; margin-bottom: 3px; }
  .subtitle { font-size: 12px; color: #003D6B; text-align: center; margin-bottom: 10px; }
  table { width: 100%; border-collapse: collapse; font-size: 11px; }
  thead tr { background-color: #003D6B !important; color: #fff; }
  th { padding: 6px 8px; font-weight: 700; text-align: center; border: 1px solid #003D6B; color: #fff; background-color: #003D6B !important; }
  ...
  tfoot tr td { background-color: #e2e8f0 !important; border: 1px solid #003D6B; font-size: 12px; font-weight: 900; color: #003D6B; text-align: center; }
...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  body { font-family: 'Cairo','Arial',sans-serif; direction: rtl; color: #0f172a; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
  .title { font-size: 16px; font-weight: 900; color: #003D6B; text-align: center; margin-bottom: 3px; }
  .subtitle { font-size: 12px; color: #003D6B; text-align: center; margin-bottom: 7px; }
  table { width: 70%; margin: 0 auto; border-collapse: collapse; font-size: 10px; }
  thead tr { background-color: #003D6B !important; color: #fff; }
  th { padding: 5px 8px; font-size: 11px; font-weight: 700; text-align: center; border: 1px solid #003D6B; color: #fff; background-color: #003D6B !important; }
  ...
  td.debt { color: #e11d48 !important; font-weight: 700; }
  tfoot tr td { background-color: #e2e8f0 !important; border: 1px solid #003D6B; font-size: 11px; font-weight: 900; color: #003D6B; }
...
body{font-family:'Cairo',Arial,sans-serif;direction:rtl;color:#0f172a;-webkit-print-color-adjust:exact;print-color-adjust:exact;}
.title{font-size:16px;font-weight:900;color:#003D6B;text-align:center;margin-bottom:8px;}
table{width:100%;border-collapse:collapse;font-size:11px;}thead tr{background-color:#003D6B!important;color:#fff;}
th{padding:6px 8px;font-weight:700;text-align:center;border:1px solid #003D6B;color:#fff;background-color:#003D6B!important;}
...
<td>${tot.warehouseRemaining}</td><td>${tot.carsRemaining}</td><td>${tot.totalRemaining}</td></tr></tfoot>
      ...
      const sectionsHtml = inventoryData.locationData.map(loc => {
        ...
        return `<h3 style="margin:12px 0 4px;font-size:13px;color:#003D6B;font-family:Cairo,Arial,sans-serif;">${loc.name} — المتبقي: ${loc.totalRemaining}</h3>
...
.title{font-size:16px;font-weight:900;color:#003D6B;text-align:center;margin-bottom:8px;}
table{width:100%;border-collapse:collapse;font-size:11px;}thead tr{background-color:#003D6B!important;color:#fff;}
th{padding:5px 8px;font-weight:700;text-align:center;border:1px solid #003D6B;color:#fff;background-color:#003D6B!important;}
...
body{font-family:'Cairo',Arial,sans-serif;direction:rtl;color:#0f172a;-webkit-print-color-adjust:exact;print-color-adjust:exact;}
.title{font-size:16px;font-weight:900;color:#003D6B;text-align:center;margin-bottom:3px;}
.subtitle{font-size:11px;color:#003D6B;text-align:center;margin-bottom:10px;}
table{width:100%;border-collapse:collapse;font-size:10px;}
thead tr{background-color:#003D6B!important;color:#fff;}
th{padding:5px 6px;font-weight:700;text-align:center;border:1px solid #003D6B;color:#fff;background-color:#003D6B!important;}
...
tfoot tr td{background-color:#003D6B!important;border:1px solid #003D6B;font-size:11px;font-weight:900;color:#fff;text-align:center;}
</style></head><body>
          ...
          <div className="space-y-6">
            ...
            {dailyDebtCity ? (
              <div className="bg-white p-8 rounded-lg border border-[#e2e8f0] overflow-x-auto" dir="rtl">
                <div className="flex justify-between items-center border-b-4 border-[#003D6B] pb-6 mb-8">
                  <h2 className="text-3xl font-bold text-[#003D6B]">تقرير المديونية اليومي</h2>
                  <div className="text-lg text-[#003D6B] font-bold space-x-4 rtl:space-x-reverse">
                ...
                <table className="w-full border-collapse border-2 border-[#003D6B]">
                  <thead>
                    <tr className="bg-[#003D6B] text-white">
                      <th className="w-[40%] px-6 py-4 text-right border-2 border-[#003D6B] text-lg">العميل</th>
                      <th className="w-[20%] px-6 py-4 text-center border-2 border-[#003D6B] text-lg">إجمالي المبيعات</th>
                      <th className="w-[20%] px-6 py-4 text-center border-2 border-[#003D6B] text-lg">المبلغ المدفوع</th>
                      <th className="w-[20%] px-6 py-4 text-left border-2 border-[#003D6B] text-lg">المديونية</th>
                    </tr>
                  </thead>
                  <tbody>
                  ...
                  <tfoot>
                    <tr className="bg-[#e2e8f0] font-black text-[#003D6B] text-xl">
                      <td className="px-6 py-4 border-2 border-[#003D6B] text-right">الإجمالي</td>
                      <td className="px-6 py-4 border-2 border-[#003D6B] text-center">{new Intl.NumberFormat('en-US').format(dailyDebtData.reduce((s, r) => s + r.totalSales, 0))}</td>
                      <td className="px-6 py-4 border-2 border-[#003D6B] text-center">{new Intl.NumberFormat('en-US').format(dailyDebtData.reduce((s, r) => s + r.totalPaid, 0))}</td>
                      <td className="px-6 py-4 border-2 border-[#003D6B] text-left text-[#e11d48]">{new Intl.NumberFormat('en-US').format(dailyDebtData.reduce((s, r) => s + r.debt, 0))}</td>
                    </tr>
                  </tfoot>
                </table>
              </div>
        ...
        {activeTab === 'pnl' && (
          <div className="max-w-2xl mx-auto">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center p-6 bg-[#003D6B] text-white rounded-xl shadow-md mt-6">
                    ...
                    return (
                      <div key={sp.id} className="bg-white border border-slate-200 rounded-xl shadow-sm p-4 flex flex-col gap-3 min-w-[280px]">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            <div className="w-12 h-12 rounded-full bg-[#003D6B] text-white flex items-center justify-center font-bold text-lg shrink-0">{initials}</div>
                            <div>
                      ...
                      <ResponsiveContainer width="100%" height="100%">
                        ...
                        >
                          ...
                          <YAxis
                            ...
                            tickLine={false}
                            width={120}
                            tick={{ fontSize: 13, fontWeight: 600, fill: '#003D6B' }}
                            mirror={false}
                          />
                          <Tooltip formatter={(value: number) => formatCurrency(value)} cursor={{ fill: '#F1F5F9' }} />
                          <Legend />
                          <Bar dataKey="sales" name="المبيعات" fill="#003D6B" barSize={14} radius={[0, 4, 4, 0]} label={{ position: 'right', formatter: (v: number) => v > 0 ? `${Math.round(v / 1000)}k` : '', fontSize: 11, fill: '#64748b' }} />
                ...
                <div>
                  ...
                  <div className="overflow-x-auto rounded-xl border border-slate-200">
                    <table className="w-full text-slate-600" style={{ fontSize: '11px' }}>
                      <thead className="text-white bg-[#003D6B]">
                        <tr>
                      ...
                      <tfoot className="bg-[#003D6B] text-white font-bold">
                        <tr>
                ...
                {inventoryData.locationData.length === 0 ? (
                  ...
                  inventoryData.locationData.map(loc => (
                    <div key={loc.id} className="rounded-xl border border-slate-200 overflow-hidden">
                      <div className="bg-[#003D6B] text-white px-4 py-2 flex justify-between items-center">
