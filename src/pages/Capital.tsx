...
export default function Capital() {
  ...
  const printInvestorTable = () => {
    ...
    const html = `<!DOCTYPE html><html dir="rtl" lang="ar"><head><meta charset="utf-8"><title>متابعة رأس المال</title>
      ...
      th,td{border:1px solid #ccc;padding:4px 6px;text-align:right}th{background:#0078d4;color:#fff;font-size:9px}
  ...
  const printSettlement = () => {
    ...
    const html = `<!DOCTYPE html><html dir="rtl" lang="ar"><head><meta charset="utf-8"><title>تصفية الرسالة</title>
      ...
      .sub{text-align:center;font-size:10px;color:#555;margin-bottom:16px}h2{font-size:12px;background:#0078d4;color:#fff;padding:4px 8px;margin:12px 0 6px}
      h3{font-size:11px;border-bottom:2px solid #0078d4;padding-bottom:2px;margin:8px 0 4px}
      table{width:100%;border-collapse:collapse;margin-bottom:8px}th,td{border:1px solid #ccc;padding:3px 6px;text-align:right}
      th{background:#0078d4;color:#fff;font-size:9px}.alt{background:#f8f9fa}.n{text-align:left;font-family:monospace}.bold{font-weight:bold}
      .line{display:flex;justify-content:space-between;padding:2px 0;border-bottom:1px dotted #e2e8f0;font-size:10px}
      .total-line{display:flex;justify-content:space-between;padding:4px 0;border-top:2px double #0078d4;font-weight:bold;font-size:11px;margin-top:4px}
                ...
                return (
                  <div key={d.partner.id} className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                    ...
                    <div className="flex items-center justify-between px-4 py-3 bg-slate-50 border-b border-slate-100">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full bg-blue-800 text-white flex items-center justify-center font-bold text-sm">{initials}</div>
                    ...
                    <div className="px-4 py-3 space-y-3 text-sm">
                      ...
                      <div className="flex justify-between pt-1">
                        ...
                        <span className="font-bold text-lg text-blue-900">{fmtSAR(d.totalDue)}</span>
                      </div>
                    </div>
        ...
        <div className="space-y-6 max-w-4xl mx-auto">
          ...
          <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-sm font-bold text-blue-900 flex items-center gap-2"><CreditCard className="w-4 h-4" />منصرفات الشركاء</h3>
          ...
          <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
            <h3 className="text-sm font-bold text-blue-900 mb-4 flex items-center gap-2"><BarChart3 className="w-4 h-4" />أ — الربح الخام</h3>
            <div className="space-y-2 text-sm">
              ...
              <div className="border-t-2 border-blue-800 pt-2 flex justify-between font-bold"><span>= الربح الخام (SDG)</span><span>{fmtSDG(settlementCalc.grossProfitSDG)}</span></div>
          ...
          <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
            <h3 className="text-sm font-bold text-blue-900 mb-4 flex items-center gap-2"><Users className="w-4 h-4" />ب — توزيع أرباح المساهمين</h3>
          ...
          {/* Section ج — Partners */}
          <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
            <h3 className="text-sm font-bold text-blue-900 mb-4 flex items-center gap-2"><CreditCard className="w-4 h-4" />ج — توزيع أرباح الشركاء</h3>
              ...
              {settlementCalc.partnerSummaries.map(ps => (
                <div key={ps.partner.id} className="bg-slate-50 p-4 rounded-xl border border-slate-200">
                  ...
                  <div className="space-y-1.5 text-sm">
                    ...
                    <div className="border-t-2 border-blue-800 pt-2 mt-2 flex justify-between font-bold text-base">
          ...
          {settlementCalc.regularInvestors.length > 0 && (
            <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
              <h3 className="text-sm font-bold text-blue-900 mb-4 flex items-center gap-2"><Building2 className="w-4 h-4" />د — ملخص المساهمين العاديين</h3>
              <div className="overflow-x-auto rounded-lg border border-slate-200">
                <table className="w-full text-sm">
                  <thead className="text-xs text-white bg-blue-800">
      ...
      {activeTab === 'verification' && verification && (
        <div className="space-y-6 max-w-3xl mx-auto">
          ...
          <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
            <h3 className="text-sm font-bold text-blue-900 mb-4">معادلة التحقق</h3>
            <div className="space-y-2 text-sm font-mono">
              ...
              <div className="border-t-2 border-blue-800 pt-3 mt-2 flex justify-between font-bold text-base">
