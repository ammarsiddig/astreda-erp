export const translations = {
  en: {
    ...
    staffManagement: 'Staff & Salaries',
    ...
    degradedBanner: 'Connection is unstable right now — retrying automatically',
    offlineBanner: 'You are offline — changes are pending until connection returns',
    ...
    deleted: 'حذف',
    mixed: 'مختلط',
    noAuditLogs: 'لا توجد سجلات تغيير بعد.',
    ...
    legacyEntry: 'سجل قديم — لا تتوفر لقطة بيانات كاملة',
    value: 'القيمة',
  ...
  ar: {
    ...
    staffManagement: 'الموظفين والرواتب',
    ...
    connected: 'متصل',
    degraded: 'اتصال غير مستقر',
    disconnected: 'غير متصل',
    degradedBanner: 'الاتصال غير مستقر حالياً — سنواصل المحاولة تلقائياً',
    offlineBanner: 'أنت غير متصل بالإنترنت — التغييرات معلقة حتى يعود الاتصال',
